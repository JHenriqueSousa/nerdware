                        ...
                        <div class="header-top-wrapper">
                            <div class="header-top-info">
                                <div class="email">
                                    ...
                                    <div class="text">
                                        <a aria-disabled="true" style="font-size: 14px; color: #989BA7;" href="mailto:nerdware@jhenriquesousa.com">nerdware@jhenriquesousa.com</a>
                                    </div>
                                </div>
                                <div class="cta">
                                    <div class="icon">
                                    ...
                                    <div class="text">
                                        <a aria-disabled="true" style="font-size: 14px; color: #989BA7;" href="tel:934693401">+351 934 693 401</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="d-none d-lg-block">
                    <nav class="menu-area d-flex align-items-center">
                        <div class="logo">
                            <a href="/"><img src="/res/site/dist/images/logo/logo.png" alt="logo" /></a>
                        </div>
                        ...
                        <div class="menu-icon ml-auto">
                            <ul>
                                ...
                                <li>
                                    <a href="/minha-conta"><svg xmlns="http://www.w3.org/2000/svg" width="18"
                ...
                <aside class="d-lg-none">
                    ...
                    <div class="mobile-nav d-flex align-items-center justify-content-between">
                        <div class="logo">
                            <a href="index.html"><img src="/res/site/dist/images/logo/logo.png" alt="logo" /></a>
                        </div>
                        <div class="search-bar">
                            <input type="text" placeholder="Search for product...">
                            <div class="icon">
