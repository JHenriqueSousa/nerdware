...
<!--
    Nerdware, desenvolvido por João Henrique Sousa
-->
<html lang="pt-br">
  <head>
    <meta charset="utf-8">
                    ...
                    <div class="header-right">
                        <ul class="list-unstyled list-inline">
                            <li class="dropdown dropdown-small">
                                <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" href="#"><span class="key">Categorias</span><b class="caret"></b></a>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="/"><img src="/res/site/img/rsz_logo_transparent.png"></a></h1>
                    </div>
                </div>
