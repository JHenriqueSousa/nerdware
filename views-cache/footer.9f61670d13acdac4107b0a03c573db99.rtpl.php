        ...
        <div class="row main-footer">
            <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                <div class="main-footer-info">
                    <h3 style="color: white">Nerdware</h3>
                    <p>
            ...
            <div class="col-lg-2 offset-lg-2 col-md-4 col-sm-6 col-12">
                <div class="main-footer-quicklinks">
                    <h6>Informação</h6>
                    <ul class="quicklink">
                        <li><a href="https://github.com/JHenriqueSousa/nerdware">Código Fonte</a></li>
                        <li><a href="mailto:nerdware@jhenriquesousa.com">Ajuda &amp; Suporte</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                <div class="main-footer-quicklinks">
                    ...
                    <ul class="quicklink">
                        ...
                        <li><a href="/user-dashboard">A Minha Conta</a></li>
                        <li><a href="/logout">Terminar Sessão</a></li>
                        <?php }else{ ?>

                        <li><a href="/login">Iniciar &amp; Criar Sessão</a></li>
                        <?php } ?>
