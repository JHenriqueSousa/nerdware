  ...
  <div align="center">
            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Recuperação da tua Palavra-passe</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Olá</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Alguém (esperamos que sejas tu) pediu-nos para redefinir a palavra-passe da tua conta Nerdware. Por favor, clique no botão abaixo para fazê-lo (1 hora). Se não solicitaste esta redefinição de palavra-passe, podes ignorar este e-mail!
                            </td>
                          </tr>
                        </table>
                        <div><!--[if mso]>
                        ...
                        style="background-color:#000;background-image:url(https://www.filepicker.io/api/file/N8GiNGsmT6mK6ORk00S7);border:1px solid #000;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:bold;text-shadow: -1px -1px #000;line-height:38px;text-align:center;text-decoration:none;width:230px;-webkit-text-size-adjust:none;mso-hide:all;">Redefinir Palavra-passe</a></div>
                        <br>
                        <div style="font-size: 13px;">Ou clica neste link: <a href="<?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?></a></div>
      ...
      <tr>
        ...
        <td class="container">
          <div class="content footer-lead">
            <a href="mailto:nerdware@jhenriquesousa.com"><b>Entra em contacto</b></a> caso precises de ajuda.
          </div>
        </td>
        <td></td>
      </tr>
    ...
    <table class="footer-wrap w320 full-width-gmail-android" bgcolor="#e5e5e5">
      <tr>
        ...
        <td class="container">
          <div class="content">
            <a href="mailto:nerdware@jhenriquesousa.com">Email</a>&nbsp;&nbsp;|&nbsp;&nbsp;
            <span class="footer-group">
              <a href="https://github.com/JHenriqueSousa">GitHub</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="https://twitter.com/JHenriqueSousaa">Twitter</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="https://www.linkedin.com/in/JHenriqueSousa/">LinkdIn</a>
            </span>
          </div>
        </td>
        <td></td>
