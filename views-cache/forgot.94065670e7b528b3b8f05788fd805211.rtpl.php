...
<div class="lockscreen-wrapper">
  ...
  <div class="lockscreen-item">
    ...
    <form  action="/admin/forgot" method="post">
      <div class="input-group">
        <input type="email" class="form-control" placeholder="Escreva aqui o seu e-mail" name="email">
  ...
  <div class="help-block text-center">
    Por favor insira o seu email em cima para receber um link de reposição da sua palavra-passe.
  </div>
