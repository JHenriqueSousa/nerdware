                    ...
                    <div class="account-sign-in">
                        ...
                        <form action="/login" id="login-form-wrap" class="login" method="post">
                            ...
                            <div class="password-info-right">
                                <a href="/forgot">Esqueceu-se da palavra-passe?</a>
                            </div>
                            <br>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="account-sign-up">
                        ...
                        <form action="/register" class="register" method="post">
                            <div class="form__div">
                                <input id="nome" name="name" type="text" class="form__input" placeholder=" " value="<?php echo htmlspecialchars( $registerValues["name"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                                <label for="nome" class="form__label">Nome Completo</label>
                            </div>
                            <div class="form__div">
                                <input name="email" id="email" type="email" class="form__input" placeholder=" " value="<?php echo htmlspecialchars( $registerValues["email"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                                <label for="email" class="form__label">Email</label>
                            </div>
                            <div class="form__div">
                                <input type="text" id="phone" name="phone" class="form__input" placeholder=" " value="<?php echo htmlspecialchars( $registerValues["phone"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
